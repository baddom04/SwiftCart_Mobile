...
namespace ShoppingList.ViewModels
{
    internal class LoggedInViewModel : ViewModelBase
    {
        ...
        public LoggedInViewModel(UserAccountModel userAccount, ManageApplicationsModel manageApplications, MainSocialPanelModel households, Action<MainPage> changePage, Action<bool> showLoading, Action<NotificationType, string> showNotification)
        {
            ...
            Menus = new Dictionary<MenuIcon, ViewModelBase>
            {
                ...
                { new MenuIcon("Social", "people_regular"), new MainSocialPanelViewModel(userAccount, manageApplications, households, showNotification, showLoading) },
