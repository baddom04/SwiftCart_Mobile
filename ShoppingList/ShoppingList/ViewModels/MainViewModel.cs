...
namespace ShoppingList.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel(UserAccountModel userAccount, MainSocialPanelModel households, ManageApplicationsModel manageApplications, ManageHouseholdsModel manageHouseholds)
        {
            _pages = new Dictionary<MainPage, ViewModelBase>()
            {
                ...
                { MainPage.Main, new LoggedInViewModel(userAccount, manageApplications, households, manageHouseholds, ChangePage, ShowLoading, ShowNotificationDialog) },
            };
