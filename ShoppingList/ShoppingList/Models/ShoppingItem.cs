...
{
    internal class ShoppingItem(string name, User owner, ObservableCollection<Comment> comments, string quantity = "", UnitType unit = UnitType.Pieces, string? description = null) : ICloneable
    {
