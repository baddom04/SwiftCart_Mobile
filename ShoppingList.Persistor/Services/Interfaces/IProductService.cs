...
namespace ShoppingList.Persistor.Services.Interfaces
{
    internal interface IProductService
    {
        ...
        Task CreateProductAsync(int segment_id, string name, string brand, string description, decimal price, CancellationToken cancellationToken = default);
        Task UpdateProductAsync(int segment_id, int product_id, string name, string brand, string description, decimal price, CancellationToken cancellationToken = default);
