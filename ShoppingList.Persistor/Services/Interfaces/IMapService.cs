...
namespace ShoppingList.Persistor.Services.Interfaces
{
    ...
    {
        Task CreateMapAsync(int store_id, int x_size, int y_size, CancellationToken cancellationToken = default);
        Task<Map> GetMapAsync(int store_id, CancellationToken cancellationToken = default);
        Task UpdateMapAsync(int store_id, int x_size, int y_size, CancellationToken cancellationToken = default);
