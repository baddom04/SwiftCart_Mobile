...
namespace ShoppingList.Persistor.Services
{
    ...
    {
        public async Task CreateLocationAsync(int store_id, string country, string zip_code, string city, string street, string detail, CancellationToken cancellationToken = default)
        {
        ...
        public async Task UpdateLocationAsync(int store_id, string country, string zip_code, string city, string street, string detail, CancellationToken cancellationToken = default)
        {
            var payload = new { country, zip_code, city, street, detail };
